...
- 2022년도 1학기 프로그래밍원리와실습(기말프로젝트)
- 개요: 텔레그램 봇(@LmsNotion_bot)에 ‘할 일’이라고 보내면 강의영상, 레포트, 퀴즈의 리스트를 자동으로 탐색한다. 셀레니움을 통해 정보를 가져오고, 봇을 이용해 하지 않은 것들은 제목과 함께 링크를 첨부하며 하라고 알려주고, 모두 했으면 완료했다고 메세지를 보내준다.
  
## Description

### lecfinder.py
> 셀레니움을 이용해 LMS 사이트를 크롤링
...
### notiontelegrambot.py
> 크롤링한 정보들을 텔레그램 봇으로 전달
